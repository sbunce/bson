...
This BSON encoder/decoder allows the programmer to be strict about coercion. If
exact BSON types are used (which is encouraged) then the encoder/decoder is
100% symmetric.
...
Coercion:
 ...
 are supported. Types not listed are unsupported and will generate errors during
 encoding.
